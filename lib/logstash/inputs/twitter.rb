...
class LogStash::Inputs::Twitter < LogStash::Inputs::Base
  ...
  config :keywords, :validate => :array, :required => false, :default => []

  config :locations, :validate => :array, :required => false, :default => []
  config :follow, :validate => :array, :required => false, :default => []
